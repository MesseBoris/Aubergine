 ...
 */
class Version20180316083249 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE commentaire ADD COLUMN id_ticket INTEGER NOT NULL');
    }
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__commentaire AS SELECT id, texte FROM commentaire');
        $this->addSql('DROP TABLE commentaire');
        $this->addSql('CREATE TABLE commentaire (id INTEGER NOT NULL, texte CLOB NOT NULL, PRIMARY KEY(id))');
        $this->addSql('INSERT INTO commentaire (id, texte) SELECT id, texte FROM __temp__commentaire');
